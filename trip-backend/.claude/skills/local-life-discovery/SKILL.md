...
description: "发现某个地点附近的好吃好玩好休息的地方。当用户说'附近有什么''周边''XXX 附近''周围''离我近的''附近好玩的''附近好吃的''附近休息''图书馆''健身房''咖啡厅''好喝的''好逛的''遛弯''闲逛'等时触发。先用地点关键词解析坐标，再并行查高德实时周边 POI 和知识库 RAG 检索，最后按分类（好吃/好玩/好休息）分组推荐，每条含名称、距离、坐标，方便前端地图标记。"
---
